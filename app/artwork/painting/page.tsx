...
const DeepZoomViewer = dynamic(
  () => import("@/components/zoom/DeepZoomViewer").then((mod) => mod.DeepZoomViewer),
  { ssr: false }
);

export default function PaintingPage() {
  const artwork = getArtworkById("painting-01");
        ...
        <div className="w-full md:w-1/3 p-6 md:p-12 lg:p-20 flex flex-col justify-between overflow-y-auto">
          ...
          <div className="hidden md:block">
            <AnimatedReveal delay={0.2} direction="down">
              <div className="text-[10px] tracking-[0.2em] mb-4 opacity-50 font-medium">02</div>
